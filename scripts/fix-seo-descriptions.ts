 ...
 *
 * Run: node scripts/fix-seo-descriptions.ts (or `ts-node scripts/fix-seo-descriptions.ts`)
 */
 ...
 */
function patchFrontmatter(content: string, description: string): string {
...
async function run(): Promise<void> {
  ...
  console.log(`\nFixed ${docsFixed} docs and ${blogFixed} blog posts.`);
}
